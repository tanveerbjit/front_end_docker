...
function ProductSorting() {
  ...
  // const limitPerPage = [1,2,3];

  // const sortBy = [
  //   {title:'Price Low',value:'priceSort',order:'asc'},
  //   {title:'Price High',value:'priceSort',order:'dsc'},
  //   {title:'Rating High',value:'ratingSort',order:'asc'},
  //   {title:'Rating Low',value:'ratingSort',order:'dsc'} ,
  //   {title:'Discount High',value:'discountSort',order:'dsc'} ,
  //   {title:'Discount Low',value:'discountSort',order:'asc'}, 
  //   {title:'Stock High',value:'stockSort',order:'dsc'},
  //   {title:'Stock Low',value:'stockSort',order:'asc'},
  //   ];
